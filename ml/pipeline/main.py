...
def main_pipeline(wav_file_path, target_parts, onnx_model_base_path="ml/models/onnx", device_name="machine_001"):
    """
...
if __name__ == "__main__":
    # 설정값들
    WAV_FILE = "test_wav/mixture.wav"  # 입력 WAV 파일
    TARGET_PARTS = ["fan", "pump", "slider", "gearbox", "bearing"]   # 분석할 부품들
    ONNX_MODEL_BASE_PATH = "ml/models/onnx"  # ONNX 모델들이 저장된 폴더
