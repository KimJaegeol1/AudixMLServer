...
def process_pt_files_with_classification(pt_files, onnx_model_base_path="models/onnx", device_name="unknown_device"):
    """
...
def analyze_pt_files_by_pattern(output_dir="output", onnx_model_base_path="models/onnx", device_name="machine_001"):
    """
...
if __name__ == "__main__":
    # 설정
    ONNX_MODEL_BASE_PATH = "models/onnx"  # 부품별 ONNX 모델들이 저장된 폴더
