...
def main_pipeline(wav_file_path, target_parts, onnx_model_base_path="models/onnx", device_name="machine_001"):
    """
...
if __name__ == "__main__":
    ...
    ONNX_MODEL_BASE_PATH = "models/onnx"  # ONNX 모델들이 저장된 폴더
